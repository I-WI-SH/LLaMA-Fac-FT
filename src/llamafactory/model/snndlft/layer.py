...
class DLRankAllocator:
    ...
    def mask_to_budget(self, model, budget, layer_wise):
        ...
        train_params = self.layer_wise_training(model, layers_ipt, layers_firing_rate, layer_wise=layer_wise)
        ...
        for name, param in model.named_parameters(): 
            if 'lora' in name:
                ...
                if match:
                    ...
                    layer_index = None   
                if layer_index and layer_index in combined_ipt_layers:
    ...
    def update_and_allocate(self, model, global_step, layer_wise, force_mask=False):
        ...
        if mask_ind or force_mask:
            rank_pattern = self.mask_to_budget(model, budget, layer_wise)
        else:
            rank_pattern = None
